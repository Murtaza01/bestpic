...
const ChallengeSection = ({ children, path,isAdd }: props) => {
  return (
    <section className="boxShadow mx-auto flex h-72 w-[90vw] flex-col justify-center rounded-lg bg-gray-50 lg:w-[57rem]">
